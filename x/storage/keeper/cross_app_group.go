...
func (app *GroupApp) GetStorageKeeper() types.StorageKeeper {
...
func (app *GroupApp) HandleUpdateGroupPackageOperation(ctx sdk.Context, pkg *types.UpdateGroupMemberSynPackage) types.UpdateGroupMemberOptions {
