...
// MigrateChanel mocks base method.
func (m *MockCrossChainKeeper) MigrateChanel(name string, id types3.ChannelID, app types3.CrossChainApplication) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "MigrateChanel", name, id, app)
	ret0, _ := ret[0].(error)
	return ret0
}

// MigrateChanel indicates an expected call of MigrateChanel.
func (mr *MockCrossChainKeeperMockRecorder) MigrateChanel(name, id, app interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "MigrateChanel", reflect.TypeOf((*MockCrossChainKeeper)(nil).MigrateChanel), name, id, app)
}
