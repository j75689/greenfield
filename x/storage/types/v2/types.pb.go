...
// source: greenfield/storage/v2/types.proto
...
type BucketInfo struct {
	...
	Visibility types.VisibilityType `protobuf:"varint,3,opt,name=visibility,proto3,enum=greenfield.storage.VisibilityType" json:"visibility,omitempty"`
	...
	SourceType types.SourceType `protobuf:"varint,5,opt,name=source_type,json=sourceType,proto3,enum=greenfield.storage.SourceType" json:"source_type,omitempty"`
	...
	BucketStatus types.BucketStatus `protobuf:"varint,10,opt,name=bucket_status,json=bucketStatus,proto3,enum=greenfield.storage.BucketStatus" json:"bucket_status,omitempty"`
}
...
func (*BucketInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_76809ef3d376dc12, []int{0}
}
...
func (m *BucketInfo) GetVisibility() types.VisibilityType {
	if m != nil {
		return m.Visibility
	}
	return types.VISIBILITY_TYPE_UNSPECIFIED
}

func (m *BucketInfo) GetSourceType() types.SourceType {
	if m != nil {
		return m.SourceType
	}
...
func (m *BucketInfo) GetBucketStatus() types.BucketStatus {
	if m != nil {
		return m.BucketStatus
	}
	return types.BUCKET_STATUS_CREATED
}
...
type InternalBucketInfo struct {
	...
	LocalVirtualGroups []*types.LocalVirtualGroup `protobuf:"bytes,3,rep,name=local_virtual_groups,json=localVirtualGroups,proto3" json:"local_virtual_groups,omitempty"`
...
func (*InternalBucketInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_76809ef3d376dc12, []int{1}
}
...
func (m *InternalBucketInfo) GetLocalVirtualGroups() []*types.LocalVirtualGroup {
	if m != nil {
...
type ObjectInfo struct {
	...
	Visibility types.VisibilityType `protobuf:"varint,8,opt,name=visibility,proto3,enum=greenfield.storage.VisibilityType" json:"visibility,omitempty"`
	...
	ObjectStatus types.ObjectStatus `protobuf:"varint,11,opt,name=object_status,json=objectStatus,proto3,enum=greenfield.storage.ObjectStatus" json:"object_status,omitempty"`
	// redundancy_type define the type of the redundancy which can be multi-replication or EC.
	RedundancyType types.RedundancyType `protobuf:"varint,12,opt,name=redundancy_type,json=redundancyType,proto3,enum=greenfield.storage.RedundancyType" json:"redundancy_type,omitempty"`
	// source_type define the source of the object.
	SourceType types.SourceType `protobuf:"varint,13,opt,name=source_type,json=sourceType,proto3,enum=greenfield.storage.SourceType" json:"source_type,omitempty"`
...
func (*ObjectInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_76809ef3d376dc12, []int{2}
}
...
func (m *ObjectInfo) GetVisibility() types.VisibilityType {
	if m != nil {
		return m.Visibility
	}
	return types.VISIBILITY_TYPE_UNSPECIFIED
...
func (m *ObjectInfo) GetObjectStatus() types.ObjectStatus {
	if m != nil {
		return m.ObjectStatus
	}
	return types.OBJECT_STATUS_CREATED
}

func (m *ObjectInfo) GetRedundancyType() types.RedundancyType {
	if m != nil {
		return m.RedundancyType
	}
	return types.REDUNDANCY_EC_TYPE
}

func (m *ObjectInfo) GetSourceType() types.SourceType {
	if m != nil {
		return m.SourceType
	}
	return types.SOURCE_TYPE_ORIGIN
...
type GroupInfo struct {
	...
	// source_type
	SourceType types.SourceType `protobuf:"varint,3,opt,name=source_type,json=sourceType,proto3,enum=greenfield.storage.SourceType" json:"source_type,omitempty"`
...
func (*GroupInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_76809ef3d376dc12, []int{3}
}
...
func (m *GroupInfo) GetSourceType() types.SourceType {
	if m != nil {
		return m.SourceType
	}
	return types.SOURCE_TYPE_ORIGIN
...
func (*Trait) Descriptor() ([]byte, []int) {
	return fileDescriptor_76809ef3d376dc12, []int{4}
}
...
func (*BucketMetaData) Descriptor() ([]byte, []int) {
	return fileDescriptor_76809ef3d376dc12, []int{5}
}
...
func (*ObjectMetaData) Descriptor() ([]byte, []int) {
	return fileDescriptor_76809ef3d376dc12, []int{6}
}
...
func (*GroupMetaData) Descriptor() ([]byte, []int) {
	return fileDescriptor_76809ef3d376dc12, []int{7}
}
...
func (*Ids) Descriptor() ([]byte, []int) {
	return fileDescriptor_76809ef3d376dc12, []int{8}
}
...
func (*DeleteInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_76809ef3d376dc12, []int{9}
}
...
func (*MigrationBucketInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_76809ef3d376dc12, []int{10}
}
...
func init() {
	proto.RegisterType((*BucketInfo)(nil), "greenfield.storage.v2.BucketInfo")
	proto.RegisterType((*InternalBucketInfo)(nil), "greenfield.storage.v2.InternalBucketInfo")
	proto.RegisterType((*ObjectInfo)(nil), "greenfield.storage.v2.ObjectInfo")
	proto.RegisterType((*GroupInfo)(nil), "greenfield.storage.v2.GroupInfo")
	proto.RegisterType((*Trait)(nil), "greenfield.storage.v2.Trait")
	proto.RegisterType((*BucketMetaData)(nil), "greenfield.storage.v2.BucketMetaData")
	proto.RegisterType((*ObjectMetaData)(nil), "greenfield.storage.v2.ObjectMetaData")
	proto.RegisterType((*GroupMetaData)(nil), "greenfield.storage.v2.GroupMetaData")
	proto.RegisterType((*Ids)(nil), "greenfield.storage.v2.Ids")
	proto.RegisterType((*DeleteInfo)(nil), "greenfield.storage.v2.DeleteInfo")
	proto.RegisterType((*MigrationBucketInfo)(nil), "greenfield.storage.v2.MigrationBucketInfo")
}

func init() { proto.RegisterFile("greenfield/storage/v2/types.proto", fileDescriptor_76809ef3d376dc12) }

var fileDescriptor_76809ef3d376dc12 = []byte{
	// 1175 bytes of a gzipped FileDescriptorProto
	,
}
	...
	for iNdEx < l {
		...
		case 3:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.Visibility |= types.VisibilityType(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		...
		case 10:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.BucketStatus |= types.BucketStatus(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
func (m *InternalBucketInfo) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			...
			m.LocalVirtualGroups = append(m.LocalVirtualGroups, &types.LocalVirtualGroup{})
	...
	for iNdEx < l {
		...
		case 11:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.ObjectStatus |= types.ObjectStatus(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 12:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.RedundancyType |= types.RedundancyType(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
