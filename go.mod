...
replace (
	...
	github.com/cosmos/cosmos-sdk => github.com/j75689/greenfield-cosmos-sdk v0.0.0-20230728101132-bf4bb854669e //github.com/bnb-chain/greenfield-cosmos-sdk v0.2.3-alpha.5
